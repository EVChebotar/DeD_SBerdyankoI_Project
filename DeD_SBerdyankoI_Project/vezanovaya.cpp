...
void VezaNovaya :: organization(QDateTime RestartDateTime, QTableWidget *Table, QTimeEdit *AccumCurrentTime, QLineEdit *isPlusAccum, QTime AlertTime, QTimeEdit *UTC, QLineEdit *UTCPlusMinus){
    ...
    while (NewTimeEtalon < QDateTime :: currentDateTime()){
        NewTimeEtalon=NewTimeEtalon.addSecs(VezaNovayaTime.second()+(VezaNovayaTime.minute()+VezaNovayaTime.hour()*60)*60);
